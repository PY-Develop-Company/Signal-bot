...
def check_signal(prices: DataFrame, interval, successful_indicators_count=4):
    ...
    print("Валютна пара", prices.symbol[0], "таймфрейм", prices.datetime[0]-prices.datetime[1])
    print("Чи є сигнал -", main_signal[1][0] >= successful_indicators_count)
    print("Покази індикаторів", signal_counts)
    print()
